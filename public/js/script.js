...
formulario.addEventListener('submit', async e => {
  ...
  if(resultado.codigo === 201) {
    ...
    mensaje.innerHTML = `<p>Se ha acortado correctamente la URL, visita <a target="_blank" rel="noopener noreferrer" href="/${resultado.url}"> https://recorurl.herokuapp.com/${resultado.url}</a></p>`;
